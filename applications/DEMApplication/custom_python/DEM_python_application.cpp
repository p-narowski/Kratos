...
namespace Kratos
{
    ...
    namespace Python
    {
        ...
        PYBIND11_MODULE(KratosDEMApplication, m)
        {
            ...
            // DPD
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DPD_SMOOTHING_LENGTH)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DPD_CUTOFF_RADIUS)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DPD_CONSERVATIVE_COEFF)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DPD_DISSIPATIVE_COEFF)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DPD_DISSIPATIVE_COEFF_NORMAL)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DPD_DISSIPATIVE_COEFF_TANGENTIAL)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DPD_FLUID_VISCOSITY)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, COUPLING_SEARCH_RADIUS)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, COUPLING_KERNEL_LENGTH)
        }
