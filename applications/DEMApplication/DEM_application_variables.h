...
#define DEM_COPY_SECOND_TO_FIRST_3(a, b) \
  ...
  a[1] = b[1];                           \
  a[2] = b[2];
#define DEM_COPY_SECOND_TO_FIRST_4(a, b) \
  a[0] = b[0];                           \
  a[1] = b[1];                           \
  a[2] = b[2];                           \
  a[3] = b[3];
#define DEM_ADD_SECOND_TO_FIRST(a, b) \
  a[0] += b[0];                       \
  a[1] += b[1];                       \
  a[2] += b[2];
#define DEM_SET_COMPONENTS_TO_ZERO_3(a) \
  a[0] = 0.0;                           \
  a[1] = 0.0;                           \
  a[2] = 0.0;
#define DEM_SET_COMPONENTS_TO_ZERO_3x3(a) \
  a[0][0] = 0.0;                          \
  a[0][1] = 0.0;                          \
  a[0][2] = 0.0;                          \
  a[1][0] = 0.0;                          \
...
#define DEM_DETERMINANT_3x3(a0, a1, a2) (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  // DPD variables
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, DPD_SMOOTHING_LENGTH)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, DPD_CUTOFF_RADIUS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, DPD_CONSERVATIVE_COEFF)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, DPD_DISSIPATIVE_COEFF)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, DPD_DISSIPATIVE_COEFF_NORMAL)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, DPD_DISSIPATIVE_COEFF_TANGENTIAL)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, DPD_FLUID_VISCOSITY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, COUPLING_SEARCH_RADIUS)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, COUPLING_KERNEL_LENGTH)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, array_1d<double, 3>, DPD_TO_DEM_COUPLING_FORCE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, array_1d<double, 3>, DEM_TO_DPD_COUPLING_FORCE)
