...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE(array_1d<double, 3>, DPD_TO_DEM_COUPLING_FORCE)
    KRATOS_CREATE_VARIABLE(array_1d<double, 3>, DEM_TO_DPD_COUPLING_FORCE)
    ...
    void KratosDEMApplication::Register()
    {
        ...
        KRATOS_REGISTER_VARIABLE(DPD_TO_DEM_COUPLING_FORCE)
        KRATOS_REGISTER_VARIABLE(DEM_TO_DPD_COUPLING_FORCE)
