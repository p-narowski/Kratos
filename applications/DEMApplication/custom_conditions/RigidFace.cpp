...
namespace Kratos
{
    ...
    void RigidFace3D::ComputeConditionRelativeData(
        int rigid_neighbour_index,
        SphericParticle *particle,
    ...
    bool RigidFace3D::CheckProjectionFallsInside(SphericParticle *p_particle)
    {
        ...
        const bool falls_inside = (alpha >= 0 && beta >= 0 && gamma >= 0 && alpha <= 1 && beta <= 1 && gamma <= 1);
